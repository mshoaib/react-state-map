...
import ApplicationForm from './icgForm';
...
const IcgSearch = () => {
    ...
    const deleteApiPath='/inv/delete-icg/';
  ...
  const columns = [
    {
      Header: "Item Cat Group",
      accessor: "Item_Cat_Group_Name",
      sortable: true,
      filterable: true
    },
    {
      Header: "Item Cat Group Desc",
      accessor: "Item_Cat_Group_Desc",
      sortable: true,
      filterable: false
    },
    {
      Header: "Item Cat Group Type",
      accessor: "Item_Cat_Grp_Type_Name",
      sortable: true,
      filterable: false
    },
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <i
              ...
              onClick={() => //console.log(props.original.UOM_ID)
                onDelete(props.original.Item_Cat_Group_ID)
              }
            >
            </i>
          </div>
