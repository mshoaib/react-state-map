...
import ApplicationForm from './uomForm';
...
const UomSearch = () => {
    ...
    const deleteApiPath='/inv/delete-uom/';
  ...
  const columns = [
    ...
    {
      Header: "UOM Short Code",
      accessor: "UOM_Short_Code",
      sortable: true,
      filterable: false
    },
    {
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <i
              ...
              onClick={() => //console.log(props.original.UOM_ID)
                onDelete(props.original.UOM_ID)
              }
            >
            </i>
          </div>
