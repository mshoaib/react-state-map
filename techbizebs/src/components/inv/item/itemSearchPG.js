...
import ApplicationForm from './itemForm';
...
const ItemSearch = () => {
    ...
    const deleteApiPath='/inv/delete-item/';
  ...
  const columns = [
    ...
    {
        Header: "Purchasable Item",
        accessor: "Purchaseable_Item_Flag",
        sortable: true,
        filterable: true
      },
      {
        Header: "Customer Orde Item ",
        accessor: "Customer_Order_Item_Flag",
        sortable: true,
        filterable: true
      },
      {
        Header: "Inventory Item ",
        accessor: "Inventory_Item_Flag",
        sortable: true,
        filterable: true
      },
      
      {
        ...
        accessor: "Sales_Order_Item_Flag",
        sortable: true,
        filterable: true
      },
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <i
              ...
              onClick={() => //console.log(props.original.UOM_ID)
                onDelete(props.original.Item_ID)
              }
            >
            </i>
          </div>
