...
import ApplicationForm from './icForm';
...
const IcSearch = () => {
    ...
    const deleteApiPath='/inv/delete-ic/';
  ...
  const columns = [
    {
      Header: "Item Cateogry",
      accessor: "Item_Category_Name",
      sortable: true,
      filterable: true
    },
    {
      Header: "Item Cateogry Desc",
      accessor: "Item_Category_Desc",
      sortable: true,
      filterable: false
    },
    {
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <i
              ...
              onClick={() => //console.log(props.original.UOM_ID)
                onDelete(props.original.Item_Category_ID)
              }
            >
            </i>
          </div>
