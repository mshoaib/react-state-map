...
import ApplicationForm from './icgtForm';
...
const IcgtSearch = () => {
    ...
    const deleteApiPath='/inv/delete-icgt/';
  ...
  const columns = [
    ...
    {
      Header: "Item Cat Group Type Desc",
      accessor: "Item_Cat_Grp_Type_Desc",
      sortable: true,
      filterable: false
    },
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <i
              ...
              onClick={() => //console.log(props.original.UOM_ID)
                onDelete(props.original.Item_Cat_Grp_Type_ID)
              }
            >
            </i>
          </div>
